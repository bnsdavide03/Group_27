...
public class Main {
	...
	public static void main(String[] args) {
		...
		lib.library[0][3]=new Tile(new Position(0,3),Color.BLUE);
		...
		lib.library[1][3]=new Tile(new Position(1,3),Color.PINK);
		lib.library[1][4]=new Tile(new Position(1,4),Color.YELLOW);
		lib.library[1][0]=new Tile(new Position(1,0),Color.GREEN);
		...
		Common_Goal08 goal = new Common_Goal08(4);
